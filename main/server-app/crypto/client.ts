...
const CONFIG: ICryptoConfig = {
  ivLength: 16, // Оптимальная длина для AES-GCM
...
// Шифрование данных
export const serverEncryptedDataFromClient = async (data: any, keys: ICryptoKey): Promise<string> => {
...
// Дешифрование данных
export const serverDecryptedDataFromClient = async (encryptedData: any, keys: ICryptoKey): Promise<any> => {
  if (!encryptedData) {
...
export const decryptedDataClient = serverDecryptedDataFromClient
export const encryptedDataClient = serverEncryptedDataFromClient